...
public class BiggestSubBSTInTree {
	...
	public static class ReturnType{
		...
		public int min;  //改子树的最小值
		public int max;  //该子树的最大值
	...
	public static ReturnType process(Node head) {
		...
		int p1 = leftSubTressInfo.size;   //可能1
		int p2 = rightSubTressInfo.size;  //可能2
